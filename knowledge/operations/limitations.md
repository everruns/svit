...
| `L-006` | Durable persistence remains local and incomplete | The address-keyed Turso adapter persists host writes/removals, activations, inbox and acknowledgement changes, paged reasoning events and compaction checkpoints, built-in refresh, forks, snapshots, queries, and cuts; durable control receipts, crash qualification, and distributed ownership are not implemented or proven |
