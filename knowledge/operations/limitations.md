...
| `L-026` | `/tasks` and `/children` are reserved empty nodes; `/inbox` accepts only explicit local host submissions | Discovery does not imply scheduling, remote delivery, or child supervision behavior |
