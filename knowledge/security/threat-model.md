...
| `TM-EFF-001` | Failed activation or host set leaves process state partially committed | One validation and commit point per transition; rollback tests for every failure class | PARTIAL — activation and host-set rollback cases pass; interpreter-panic containment remains required |
